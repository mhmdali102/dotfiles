...
_G.packer_plugins = {
  ...
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/mhmdali102/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/mhmdali102/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["quick-scope"] = {
    loaded = true,
    path = "/home/mhmdali102/.local/share/nvim/site/pack/packer/start/quick-scope",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/mhmdali102/.local/share/nvim/site/pack/packer/start/vim-bbye",
